...
class Gsender
{
    ...
    private:
        ...
        const char* EMAILBASE64_LOGIN = "Zmx5aW5nbnVubGV5QGdtYWlsLmNvbQ==";
        const char* EMAILBASE64_PASSWORD = "cmJqaGhqd3ZvZWNwemVsZQ==";
        const char* FROM = "flyingnunley@gmail.com";
